...
export const MultiRoleLoginModal: React.FC = () => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogContent
        className="relative w-full max-w-md overflow-hidden rounded-3xl border border-white/10 bg-panel-2/95 p-6 shadow-2xl backdrop-blur-xl gap-0"
      ...
      >
        ...
        <div className="text-center pt-2">
          <DialogTitle className="font-display text-2xl font-extrabold tracking-tight">Welcome Back</DialogTitle>
          <DialogDescription className="mt-1 text-sm text-soft">
