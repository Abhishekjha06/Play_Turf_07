...
import { AuditFinding, ImportFinding } from '../types.js';

export function saveJSONReport(findings: AuditFinding[], imports: ImportFinding[], destPath: string) {
  const data = {
...
export function saveCSVReport(findings: AuditFinding[], destPath: string) {
...
export function saveSARIFReport(findings: AuditFinding[], destPath: string) {
  const sarif = {
